 ...
 *        syntax.
 *
 * 10-12-19 Mikael Bonnier <mikael.bonnier@gmail.com> (MOB tags changes)
 *      - Added option -6, that outputs F66. Now requires #define F77.
 *
 */
...
int f77 = YES;                  /* Flag for chosing f66 or f77 MOB */
...
/* MOB	while ((c=our_getopt(argc, argv, "C?n:l:o:")) != EOF) */
	while ((c=our_getopt(argc, argv, "C?6l:o:")) != EOF)
	switch (c) {
		case 'C':
